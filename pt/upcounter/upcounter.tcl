...
## Setting files/paths
set verilog_files {../../dc/upcounter/upcounter.nl.v}
set my_toplevel upcounter
...
read_vcd "../../qsim_dc/upcounter/upcounter.vcd" -strip_path "testbench/upcounter_0"
...
write_sdf -context verilog "./upcounter.sdf"
